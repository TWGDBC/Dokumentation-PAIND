...
\fancyhead[L]{Pfichtenheft} %Kopfzeile links
\fancyhead[C]{} %zentrierte Kopfzeile
\fancyhead[R]{Hochschule Luzern T\&A} %Kopfzeile rechts
\renewcommand{\headrulewidth}{0.4pt} %obere Trennlinie
\fancyfoot[L]{Daniel Zimmermann} %Fusszeile links
\fancyfoot[C]{\thepage} %Seitennummer
\fancyfoot[R]{16. Oktober 2017}
...
\firstExaminer{Dr. Björn Jensen}
\secondExaminer{Prof. Dr. Markus Thalmann}
	...
	\begin{center}
		...
		\begin{flushleft}
			\begin{tabular}[t]{rl}
				...
				\textbf{Industriepartner:} & Dr. Thomas Nussbaumer \\
