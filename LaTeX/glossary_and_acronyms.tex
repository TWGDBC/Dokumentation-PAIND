\begin{acronym}[LAMS aaaaaaaaa]
	  \acro{ARM}{Acorn Risc Machine}					\\	 \acroextra{verbreitetes Mikroprozessor-Design, das grösstenteils 32Bit-Prozessoren beruht(ARMv7)}
      ...
      \acro{PWM}{Pulsweitenmodulation}					 \\ \acroextra{Modulationsverfahren mit Rechteckimpulsen}
      \acro{Quaternionen}{Erweiterung der komplexen Zahlen}								\\ \acroextra{Beschreibung von Drehbewegungen, bietet den Vorteil von eindutigen 3D Positionen}
      ...
      \acro{Scope}{Sichbarkeitsbereich}		 \\ \acroextra{Sichtbarkeitsbereich einer Variable in der Programmierung}
